 ...
 */
export function convergeOptions(options) {
    return {
        // Prettier base options
        printWidth: options.printWidth,
        pugPrintWidth: options.pugPrintWidth === -1 ? options.printWidth : options.pugPrintWidth,
        singleQuote: options.singleQuote,
        pugSingleQuote: options.pugSingleQuote ?? options.singleQuote,
        tabWidth: options.tabWidth,
        pugTabWidth: options.pugTabWidth === -1 ? options.tabWidth : options.pugTabWidth,
