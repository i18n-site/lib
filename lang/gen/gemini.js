...
const list = li
  ...
  .map((i) => {
    ...
    let n = name.trim();
    if (n === "中文（简体和繁体）") n = "中文";
    return [n, code.replace(")", "").trim()];
  });

list.push(["正體中文", "zh-TW"]);
