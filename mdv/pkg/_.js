...
/**
 * @param {Array<any>} id_url_li
 * @returns {Uint8Array}
 */
module.exports.id_url_li = function (id_url_li) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.id_url_li(retptr, addHeapObject(id_url_li));
...
module.exports.__wbg_valueOf_ba79926ba44b5e3e = function (arg0) {
